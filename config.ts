...
export const projectLists: ProjectLists = [
	...
	},
	{
		...
		projects: [
			...
			{
				title: 'quick',
				desc: '一个视频栏目，帮助你快速学会编程知识',
				href: 'https://github.com/dishait/quick'
			},
			{
			...
			},
			{
				...
				desc: '递归获取文件夹大小，使用 go，足够快，可以跑在 node 中',
				href: 'https://github.com/markthree/go-get-folder-size'
			},
			{
				title: 'nuxt3-intelligence',
				desc: 'nuxt3 的智能工具集合',
				href: 'https://github.com/markthree/nuxt3-intelligence'
			}
		]
	},
	{
